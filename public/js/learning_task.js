...
var controlQuestion1 = {
    type: 'survey-multi-choice',
    questions: [
        { prompt: "Question 1: What does the bottom number (+4) in Round 31 represent?", name: 'Q1', options: question_1_options, required: true }
    ],
    preamble: `<div> <br><br/>
    </div>
    <br><br/>
...
var controlQuestion1Response = {
    ...
    stimulus: function(){
        ...
        if(feedback_question_1){
          ...
          <br><br/> 
          <div>Question 1: What does the bottom number (+4) in Round 31 represent? </div>
          <br><br/> 
            <div>Round 31 – Feedback screen</div>
            <img class = 'img_questions' src="img/control/control_img_1.png"></img>
            <div>Round 32 – Feedback screen</div>
            ...
            one immediately after your choice (always the bottom image) and one in the next round (always the top image). <br>
            Therefore, the number +4 on the bottom image (the dark gray square) represents <font color = 'green';>the first payoff for the dark gray square </font>. 
            <br><br/>
          When you are ready, press the  <b>SPACE BAR</b> to continue. 
          <br><br/> 
          </div>`
...
var controlQuestion2 = {
    type: 'survey-multi-choice',
    questions: [
        { prompt: "Question 2: What does the top number (+9) in Round 31 represent?", name: 'Q2', options: question_2_options, required: true }
    ],
    preamble: `<div> <br><br/>
...
var controlQuestion2Response = {
    ...
    stimulus: function(){
        ...
        if(feedback_question_2){
          ...
          <div>Your answer was <font size=120%; font color = 'red';>incorrect </font>!</div>
          <br><br/> 
          <div>Question 2: What does the top number (+9) in Round 31 represent? </div>
          <br><br/> 
            <div>Round 31 – Feedback screen</div>
            <img class = 'img_questions' src="img/control/control_img_1.png"></img>
            <div>Round 32 – Feedback screen</div>
            ...
            Recall that each image will give you 2 payoffs; <br>
            one immediately after your choice (always the bottom image) and one in the next round (always the top image). <br>
            Therefore, the number +9 on the top image (the white square) represents  <font color = 'green';>the second payoff for the white square </font>. 
            <br><br/>
          When you are ready, press the  <b>SPACE BAR</b> to continue. 
          <br><br/> 
          </div>`
